...
<div class="row justify-content-center">
            ...
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    ...
                    <input class="form-control" value="{{ $kinerja->periode_penilaian }}" type="text" name="periode_penilaian" disabled>
                </div>
                <div class="col-md-4 mb-3">
                    <label for="">Tanggal :</label>
                    <input class="form-control" value="{{ $kinerja->tanggal }}" type="date" name="tanggal" disabled>
                </div>
                </div>
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    <label for="">Nama Penilai :</label>
                    <input class="form-control" value="{{ $kinerja->nama_penilai }}" type="text" name="nama_penilai" disabled>
                </div>
                <div class="col-md-4 mb-3">
                    <label for="">Nama Karyawan :</label>
                    <input class="form-control" value="{{ $kinerja->nama_karyawan }}" type="text" name="nama_karyawan" disabled>
                </div>
                </div>
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    <label for="">Jabatan :</label>
                    <input class="form-control" value="{{ $kinerja->jabatan }}" type="text" name="jabatan" disabled>
                </div>
                <div class="col-md-4 mb-3">
                    <label for="">Departemen :</label>
                    <input class="form-control" value="{{ $kinerja->departemen }}" type="text" name="departemen" disabled>
                </div>
                </div>
                <div class="col-md-9 mb-5">
                        <label for="">Deskripsi Pekerjaan : </label>
                        <input class="form-control" value="{{ $kinerja->deskripsi_pekerjaan }}" type="text" name="deskripsi_pekerjaan" disabled>
                        </div>
               ...
               <tr>
            <tr>  
                <td rowspan="6"><input type="number" value="{{ $kinerja->nilai1 }}" name="nilai1" class="form-control" required></td>  
            </tr> 
               ...
               <th colspan="3">Hasil kinerja sangat baik dan menyesuaikan lebih awal dari waktu
                ...
                <input type="text" value="{{ $kinerja->keterangan1 }}" name="keterangan1" class="form-control" required>
                <br>
                <br>
                <br>
               ...
               <tr>
            <tr>  
                <td rowspan="6"><input type="number" value="{{ $kinerja->nilai2 }}" name="nilai2" class="form-control" required></td>  
            </tr> 
               ...
               bagiannya dengan hasil kerja yang memuaskan</th>
                ...
                <label for="">Keterangan:</label>
                <input type="text" value="{{ $kinerja->keterangan2 }}" name="keterangan2" class="form-control" required>
                <br>
                <br>
                <br>
               ...
               <tr>
            <tr>  
                <td rowspan="6"><input type="number" value="{{ $kinerja->nilai3 }}" name="nilai3" class="form-control" required></td>  
            </tr> 
               ...
               <th colspan="3">Mampu menyelesaikan pekerjaan lebih awal dari waktu yang ditentukan</th>
                ...
                <br>
                <label for="">Keterangan:</label>
                <input type="text" value="{{ $kinerja->keterangan3 }}" name="keterangan3" class="form-control" required>
                <br>
                <br>
                <br>
               ...
               <tr>
            <tr>  
                <td rowspan="6"><input type="number" value="{{ $kinerja->nilai4 }}" name="nilai4" class="form-control" required></td>  
            </tr> 
               ...
               dan prosedur kerja</th>
                ...
                <br>
                <label for="">Keterangan:</label>
                <input type="text" value="{{ $kinerja->keterangan4 }}" name="keterangan4" class="form-control" required>
                <br>
                <br>
                <br>
               ...
               <tr>
            <tr>  
                <td rowspan="6"><input type="number" value="{{ $kinerja->nilai5 }}" name="nilai5" class="form-control" required></td>
               <th>100</th>
               <th>95</th>
               <th>90</th>
               <th>85</th>
            ...
            izin pulang cepat)</th>
                ...
                <br>
                <label for="">Keterangan:</label>
                <input type="text" value="{{ $kinerja->keterangan5 }}" name="keterangan5" class="form-control" required>
                <br>
                <br>
                <br>
               ...
               <tr>
            <tr>  
                <td rowspan="6"><input type="number" value="{{ $kinerja->nilai6 }}" name="nilai6" class="form-control" required></td>  
            </tr> 
            ...
            dalam mengembangan diri</th>
                ...
                <br>
                <label for="">Keterangan:</label>
                <input type="text" value="{{ $kinerja->keterangan6 }}" name="keterangan6" class="form-control" required>
                <br>
                <br>
                <br>
               ...
               <tr>
            <tr>  
                <td rowspan="6"><input type="number" value="{{ $kinerja->nilai7 }}" name="nilai7" class="form-control" required></td>  
            </tr> 
            ...
            dan menerima saran</th>
                ...
                <br>
                <label for="">Keterangan:</label>
                <input type="text" value="{{ $kinerja->keterangan7 }}" name="keterangan7" class="form-control" required>
                <br>
                <br>
                <br>
               ...
               <tr>
            <tr>  
                <td rowspan="6"><input type="number" value="{{ $kinerja->nilai8 }}" name="nilai8" class="form-control" required></td> 
            </tr> 
            ...
            Dalam hal yang kompleks kadangkala masih perlu arahan.</th>
                ...
                <br>
                <label for="">Keterangan:</label>
                <input type="text" value="{{ $kinerja->keterangan8 }}" name="keterangan8" class="form-control" required>
                <br>
                <br>
                <br>
               ...
               <tr>
            <tr>  
                <td rowspan="6"><input type="number" value="{{ $kinerja->nilai9 }}" name="nilai9" class="form-control" required></td></td>  
            </tr> 
            ...
            <th colspan="3">Selalu dapat diharapkan untuk mengembangkan gagasan dan solusi kreatif</th>
                ...
                <br>
                <label for="">Keterangan:</label>
                <input type="text" value="{{ $kinerja->keterangan9 }}" name="keterangan9" class="form-control" required>
                <br>
                <br>
                <br>
               ...
               <tr>
            <tr>  
                <td rowspan="6"><input type="number" value="{{ $kinerja->nilai10 }}" name="nilai10" class="form-control" required></td> 
            </tr> 
            ...
            <th colspan="3">Diatas rata-rata dalam memprioritaskan tugas-tugas,aktifitas dan tujuan</th>
                ...
                <br>
                <label for="">Keterangan:</label>
                <input type="text" value="{{ $kinerja->keterangan10 }}" name="keterangan10" class="form-control" required>
                <br>
                <br>
                <br>
            ...
            <div class="col-lg-10">
               ...
               <tr>
            <tr>  
                <td rowspan="6"><input type="number" value="{{ $kinerja->jumlah }}" name="jumlah" class="form-control" required></td> 
            </tr> 
               ...
               <th colspan="3"><input type="number" value="{{ $kinerja->sangat_baik }}" name="sangat_baik" class="form-control" required></th>
               <th colspan="3"><input type="number" value="{{ $kinerja->baik }}" name="baik" class="form-control" required></th>
               <th colspan="3"><input type="number" value="{{ $kinerja->cukup }}" name="cukup" class="form-control" required></th>
               <th colspan="3"><input type="number" value="{{ $kinerja->kurang }}" name="kurang" class="form-control" required></th>
               <th colspan="3"><input type="number" value="{{ $kinerja->sangat_kurang }}" name="sangat_kurang" class="form-control" required></th>
                             </table>
                <div class="col-md-9 mb-5">
                        <label for="">Rangkuman Evaluasi : </label>
                        <input type="text" value="{{ $kinerja->rangkuman_evaluasi }}" name="rangkuman_evaluasi" class="form-control" required>
                        </div>

                <div class="col-md-9 mb-5">
                        <label for="">Rekomendasi : </label>
                        <input type="text" value="{{ $kinerja->rekomendasi }}" name="rekomendasi" class="form-control" required>
                        </div>

                <div class="form-group">
                 <a href="{{ url('/kinerja') }}" class="btn btn-warning">Kembali</a>
                 </div>
